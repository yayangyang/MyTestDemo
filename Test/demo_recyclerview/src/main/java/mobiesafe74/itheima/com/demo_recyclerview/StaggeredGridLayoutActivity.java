...
import mobiesafe74.itheima.com.demo_recyclerview.java.it.gmariotti.recyclerview.itemanimator.SlideInOutLeftItemAnimator;
...
public class StaggeredGridLayoutActivity extends ActionBarActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// 设置item动画
//		mRecyclerView.setItemAnimator(new DefaultItemAnimator());//默认动画注释掉也有动画效果
		...
		mStaggeredHomeAdapter.setOnItemClickLitener(new StaggeredHomeAdapter.OnItemClickLitener()
		{
			...
			public void onItemClick(View view, int position)
			{
				Toast.makeText(StaggeredGridLayoutActivity.this,
						position + " click", Toast.LENGTH_LONG).show();
			}
