...
//        takeVideoBtn.setOnClickListener(takeVideoClickListener);
    ...
    private final View.OnClickListener takePiClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Log.e(LOG_TAG, "Take Picture Button Click");
            // 利用系统自带的相机应用:拍照
    ...
    private final View.OnClickListener takeVideoClickListener = new View.OnClickListener() {
        ...
        @Override
        public void onClick(View v) {
            Log.e(LOG_TAG, "Take Video Button Click");
            // 摄像
    ...
    private static File getOutputMediaFile(int type) {
        ...
        try {
            ...
            if(mediaStorageDir!=null){
                Log.e(LOG_TAG, "Successfully created mediaStorageDir: "
                        + mediaStorageDir);
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        Log.e(LOG_TAG, "onActivityResult: requestCode: " + requestCode
                + ", resultCode: " + requestCode + ", intent: " + intent);
        // 如果是拍照
        if (CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE == requestCode) {
            Log.e(LOG_TAG, "CAPTURE_IMAGE");

            if (RESULT_OK == resultCode) {
                Log.e(LOG_TAG, "RESULT_OK");
